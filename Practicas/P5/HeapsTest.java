...
public class HeapsTest {
	...
	public static void main(String[] args) {
		tests(new BinaryHeap<Integer>(), "BinaryHeap<Integer> (transp. 41-48)" );
		tests(new WBLeftistHeap<Integer>(), "WeigthBiasedLeftistHeap<Integer>");
		tests(new MaxiphobicHeap<Integer>(),"MaxiphobicHeap<Integer>");
	}
