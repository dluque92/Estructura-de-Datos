...
import dataStructures.graph.TopologicalSortingDQ;
...
public class TopSortDemo {
    public static void main(String[] args) {
        ...
        DiGraph<Integer> g1 = new DictionaryDiGraph<Integer>();
        ...
        DiGraph<Integer> g2 = new DictionaryDiGraph<Integer>();
        ...
        DiGraph<Integer> g3 = new DictionaryDiGraph<Integer>();
        ...
        // choose graph
        DiGraph<Integer> g = g1; // g1, g2, g3

        System.out.println(g);

        TopologicalSortingDic<Integer> topSort = new TopologicalSortingDic<Integer>(
                g);
        if (!topSort.hasCycle())
        ...
        TopologicalSortingDicPar<Integer> topSortPar = new TopologicalSortingDicPar<Integer>(
                g);
